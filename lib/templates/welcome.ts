...
<head>
    ...
    <title>NIA INTERNATIONAL에 오신 것을 환영합니다!</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>NIA INTERNATIONAL</h1>
            <h2>NIA INTERNATIONAL에 오신 것을 환영합니다!</h2>
        </div>
        
        <div class="content">
            <p>안녕하세요, <strong>${user.name}</strong>님!</p>
            <p>NIA INTERNATIONAL의 회원이 되신 것을 진심으로 환영합니다. 저희 플랫폼에서 최신 K-Fashion 트렌드를 만나보세요.</p>
        ...
        <div class="footer">
            ...
            <p>상담시간: 평일 09:00-17:30, 토요일 09:00-13:00</p>
...
NIA INTERNATIONAL의 회원이 되신 것을 진심으로 환영합니다. 저희 플랫폼에서 최신 K-Fashion 트렌드를 만나보세요.
